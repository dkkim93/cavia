...
class AntVelCrippleEnv(AntEnv):
    ...
    def __init__(self, task={}):
        ...
        super(AntVelCrippleEnv, self).__init__()

    def step(self, action):
        # Apply cripple mask
        cripple_prob = 0
        cripple_mask = np.ones(action.shape)
        cripple_mask[2] = cripple_prob
        cripple_mask[3] = cripple_prob
        cripple_mask[4] = cripple_prob
        cripple_mask[5] = cripple_prob

        action = cripple_mask * action
